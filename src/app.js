...
const communityReportRoutes = require('./routes/communityReport.routes');
const hrRoutes = require('./routes/hr.routes');
const staffAnnouncementsRoutes = require('./routes/staffAnnouncements.routes');
const conectaRoutes = require('./routes/conecta.routes');
const informaRoutes = require('./routes/informa.routes');
...
app.use('/community-reports', communityReportRoutes);
app.use('/hr', hrRoutes);
app.use('/staff-announcements', staffAnnouncementsRoutes);
app.use('/conecta', conectaRoutes);
app.use('/informa', informaRoutes);
