...
const academicCommunicationAssetSchema = new mongoose.Schema({
...
academicCommunicationAssetSchema.index({ schoolId: 1, createdAt: -1 });

module.exports = registerSchoolScopedModel('AcademicCommunicationAsset', academicCommunicationAssetSchema);
