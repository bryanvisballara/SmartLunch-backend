...
const walletSchema = new mongoose.Schema(
  {
    ...
    autoDebitAgreementId: { type: String, default: '', trim: true },
    autoDebitAgreementStatus: { type: String, default: '', trim: true },
    autoDebitAgreementLastSyncAt: { type: Date, default: null },
