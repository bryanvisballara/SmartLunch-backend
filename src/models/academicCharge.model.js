...
const academicChargeSchema = new mongoose.Schema(
  {
    ...
    originalAmount: { type: Number, min: 0, default: 0 },
    amountLocked: { type: Boolean, default: false, index: true },
    amountAdjustmentNote: { type: String, trim: true, default: '' },
    amountAdjustedAt: { type: Date, default: null },
    amountAdjustedByUserId: { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null },
