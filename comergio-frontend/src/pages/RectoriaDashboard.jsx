      ...
      setSuccess(
        editingResourcePlannerCycleId
          ...
          : (resourcePlannerCycleDraft.publishAsAnnouncement
            ? 'Planner creado y publicado en Comunicados internos para docentes.'
              ...
              {!editingResourcePlannerCycleId ? (
                <label className="rectoria-checkbox-field">
                  <input
                    ...
                    type="checkbox"
                  />
                  <span>También publicar en Comunicados internos para que los docentes lo vean y confirmen lectura</span>
                </label>
              ) : null}
